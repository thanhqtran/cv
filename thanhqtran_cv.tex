...
\item Dual Caregiving, Declining Birth Rate, and Economic Sustainability, \textit{with} Akiomi Kitagawa. \href{https://ideas.repec.org/p/dpc/wpaper/0325.html}{(DEPOCEN WP 193)}
...
\item Old-Age Security in an Aging Economy: Revisited (with Van-Quy Le).

\item Rational Addiction, Cigarette Consumption and Quitting Determinants (with Tuong-Vy Phan, Anh Ngoc Nguyen).
