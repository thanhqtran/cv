...
\item Demographic Change and Long-Run Inequality Trends: 30 Years of Evidence from Vietnam (with \href{https://scholar.google.com/citations?user=uROWXaAAAAAJ&hl=vi}{Huy Le Vu}).

\item Old-Age Security in an Aging Economy: Revisited (with \href{https://sites.google.com/view/vanquy93/}{Van-Quy Nguyen}).

\item Rational Addiction, Cigarette Consumption and Quitting Determinants (with \href{https://scholar.google.com/citations?user=WcA9kdQAAAAJ&hl=en}{Tuong-Vy Phan}, \href{https://sites.google.com/depocen.org/anhnguyen/home?authuser=0}{Anh Ngoc Nguyen}).

\item What Drives Business Cycles in Vietnam? Evidence from an Estimated SOE DSGE Model.

\item The Roles of Fiscal and Monetary Policies in Vietnam: A New Keynesian Approach (with \href{https://scholar.google.com/citations?user=zvwUmYkAAAAJ&hl=fr}{Cuong Le Van})
