...
\hspace{1em}\textit{Conducting independent research on development economics and policy analysis, macroeconomic modelling. Contributing to policy analysis and consulting works for NGO.}

\vspace{0.3em}

\textbf{Visiting Fellow}, Research Center for Policy Design, Tohoku University \hfill \emph{2025/08 -- current} \\
\hspace{1em}\textit{Collaborating with faculty on research projects examining policy design for sustainable development}

\vspace{0.3em}

\textbf{Research Fellow (DC2)}, Japan Society for the Promotion of Science, Japan \hfill \emph{2023/04 -- 2025/03} \\
\hspace{1em}\textit{Conducted doctoral research on demography and overlapping generations models.}
