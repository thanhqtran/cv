...
\textit{Conducting independent research on development economics, policy analysis, and macroeconomic modelling. Contributing to policy analysis and consulting works for NGO.} \\

\textbf{Visiting Fellow}, Research Center for Policy Design, Tohoku University \hfill \emph{2025/08 -- current} \\
\textit{Collaborating with faculty on research projects examining policy design for sustainable development} \\

\textbf{Research Fellow (DC2)}, Japan Society for the Promotion of Science, Japan \hfill \emph{2023/04 -- 2025/03} \\
\textit{Conducted doctoral research on demography and overlapping generations models.}
